export const AG_GRID_LOCALE_FR = {
    ...
    lessThanOrEqual: 'Inférieur ou égale',
    ...
    // Filter Titles
    textFilter: 'Filtre par texte',
    numberFilter: 'Filtre par nombre',
    dateFilter: 'Filtre par date',
    setFilter: 'Appliquer filtre',
  
    // Group Column Filter
    groupFilterSelect: 'Selectionne un champ:',
    ...
    loadingError: 'ERR',
    noRowsToShow: 'Auccun ligne à afficher',
    enabled: 'Enabled',
    ...
    pageLastRowUnknown: '?',
    nextPage: 'Suivante',
    lastPage: 'Dérnière Page',
    firstPage: 'Première page',
    previousPage: 'Précedente',
